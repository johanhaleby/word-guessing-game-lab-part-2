...
class GameLostReadModel(override val gameId: UUID, override val startedAt: Date, override val endedAt: Date,
...
data class GameWonReadModel(override val gameId: UUID, override val startedAt: Date, override val endedAt: Date,
                            override val category: String, override val totalNumberOfGuesses: Int,
